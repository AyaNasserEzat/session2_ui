...
/*void main(){
  ...
  children:[
            Container(
        padding: EdgeInsets.all(8),  color: Colors.blue,width: double.infinity,height: 150,
             child: Column(
     mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start,
            children:[
              ...
              SizedBox(height: 8,),
                 ...
                 SizedBox(height: 5,),
                 Text('ayanasser1853@gmail.com',style: TextStyle(color: Colors.white),),
              ],
            ),),],),
  ...
  trailing: Column(
    children: [
          ...
          ListTile(
            ...
            title: Row( children:[Text('shosho'),Icon(Icons.favorite,color: Colors.red,size: 15,),],),
            subtitle:Row(children: [
              Icon(Icons.check),
          ...
          ListTile(
            ...
            title: Row( children:[Text('Mona'),Icon(Icons.favorite,color: Colors.purple,size: 15,),],),
            subtitle:Row(children: [
          ...
          ListTile(
            ...
            title: Row( children:[Text('Toqa'),Icon(Icons.favorite,color: Colors.purple,size: 15,),],),
            subtitle:Row(children: [
              Icon(Icons.done_all,color: Colors.blue,),
              Text('done'),
            ],),
